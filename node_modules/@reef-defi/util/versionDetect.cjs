...
var _xGlobal = require("@reef-defi/x-global");
...
function detectPackage(_ref3, pathOrFn) {
  ...
  (0, _assert.assert)(name.startsWith('@reef-defi') || name.startsWith('@polkadot/wasm-crypto'), () => `Invalid package descriptor ${name}`);
