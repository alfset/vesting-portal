const polkadotApi = (function (exports, keyring, util, types, definitions, utilCrypto) {
  'use strict';
        ...
        value: response => {
          ...
          try {
            ...
            if (subscription) {
              ...
              _classPrivateFieldBase(this, _subscriptions$1)[_subscriptions$1][subId] = _objectSpread$v(_objectSpread$v({}, subscription), {}, {
                method,
                params
  ...
  ***************************************************************************** */
  ...
  const standaloneTypes = _objectSpread$u(_objectSpread$u({}, sharedTypes$5), {}, {
  ...
  const versioned$8 = [{
    minmax: [240, 243],
    types: _objectSpread$u(_objectSpread$u({}, standaloneTypes), {}, {
      ProxyType: {
    ...
    minmax: [244, 999],
    types: _objectSpread$u({}, standaloneTypes)
  }, {
    minmax: [1000, undefined],
    types: _objectSpread$u({}, sharedTypes$5)
  }];
  ...
  const versioned$7 = [{
    ...
    minmax: [9010, 9099],
    types: _objectSpread$t(_objectSpread$t({}, sharedTypes$4), definitions.mapXcm('V0'))
  }, {
    // jump from 9100 to 9110, however align with Rococo
    minmax: [9100, 9105],
    types: _objectSpread$t(_objectSpread$t({}, sharedTypes$4), definitions.mapXcm('V1'))
  }, {
    // metadata v14
  ...
  const versioned$3 = [{
    ...
    minmax: [229, 9099],
    types: _objectSpread$r(_objectSpread$r({}, sharedTypes$2), definitions.mapXcm('V0'))
  }, {
    minmax: [9100, 9105],
    types: _objectSpread$r(_objectSpread$r({}, sharedTypes$2), definitions.mapXcm('V1'))
  }, {
    // metadata v14
    minmax: [9106, undefined],
  ...
  const versioned$1 = [{
    minmax: [0, 3],
    types: _objectSpread$q(_objectSpread$q({}, sharedTypes$1), definitions.mapXcm('V0'))
  }, {
    minmax: [4, 5],
    types: _objectSpread$q(_objectSpread$q({}, sharedTypes$1), definitions.mapXcm('V1'))
  }, {
    // metadata V14
  ...
  const versioned = [{
    ...
    minmax: [50, 9099],
    types: _objectSpread$p(_objectSpread$p({}, sharedTypes), definitions.mapXcm('V0'))
  }, {
    minmax: [9100, 9105],
    types: _objectSpread$p(_objectSpread$p({}, sharedTypes), definitions.mapXcm('V1'))
  }, {
    // metadata v14
    minmax: [9106, undefined],
  ...
  class Init extends Decorate {
    ...
    async at(blockHash) {
      ...
      const registry = await this.getBlockRegistry(u8aHash); // always create a new decoration - since we are pointing to a specific hash, this
...
})({}, polkadotKeyring, polkadotUtil, polkadotTypes, definitions, polkadotUtilCrypto);
