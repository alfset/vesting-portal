...
function createCoded(secretKey, chainCode) {
  return {
    chainCode,
    publicKey: (0, _index2.secp256k1KeypairFromSeed)(secretKey).publicKey,
    secretKey
  };
}
...
function deriveChild(hd, index) {
  ...
  try {
    const I = (0, _index.hmacSha512)(hd.chainCode, data);
...
function hdEthereum(seed) {
  ...
  const I = (0, _index.hmacSha512)(MASTER_SECRET, seed);
