...
function openApp(appParams, options) {
  ...
  window.location.href = url; // var ifr = document.createElement('iframe');
  // ifr.src = url;
...
function showNanoInstallTip(options) {
  ...
  installBtn.onclick = function () {
    ...
    background = null; //window.location.href = "https://nano.nebulas.io/";
...
},{"./Utils":1,"./appHandler":2,"./config":3,"./extensionHandler":4,"./qrcode":7,"bignumber.js":9}],7:[function(require,module,exports){
"use strict";
...
var createDeaultQRContainer = function (options) {
  ...
  background.onclick = function () {// if (background !== null) {   //change: qrcode should be cancelled when click background
    // 	body.removeChild(background);
...
},{"./Utils":1,"qrcode":15}],8:[function(require,module,exports){
'use strict'
...
},{"./can-promise":16,"./core/qrcode":32,"./renderer/canvas":39,"./renderer/svg-tag.js":40}],16:[function(require,module,exports){
...
},{"./mode":29}],19:[function(require,module,exports){
function BitBuffer () {
  this.buffer = []
  this.length = 0
}
...
},{"../utils/buffer":42}],21:[function(require,module,exports){
var BufferUtil = require('../utils/buffer')
var Mode = require('./mode')
...
},{"../utils/buffer":42,"./mode":29}],22:[function(require,module,exports){
...
},{"./error-correction-level":23}],23:[function(require,module,exports){
exports.L = { bit: 1 }
exports.M = { bit: 0 }
exports.Q = { bit: 3 }
exports.H = { bit: 2 }
...
},{"../utils/buffer":42}],27:[function(require,module,exports){
var Mode = require('./mode')
var Utils = require('./utils')
...
},{"./mode":29,"./utils":36}],28:[function(require,module,exports){
/**
...
},{"./regex":34,"./version-check":37}],30:[function(require,module,exports){
var Mode = require('./mode')
...
},{"./mode":29}],31:[function(require,module,exports){
var BufferUtil = require('../utils/buffer')
...
},{"../utils/buffer":42,"./galois-field":26}],32:[function(require,module,exports){
var BufferUtil = require('../utils/buffer')
var Utils = require('./utils')
var ECLevel = require('./error-correction-level')
...
},{"../utils/buffer":42,"./alignment-pattern":17,"./bit-buffer":19,"./bit-matrix":20,"./error-correction-code":22,"./error-correction-level":23,"./finder-pattern":24,"./format-info":25,"./mask-pattern":28,"./mode":29,"./reed-solomon-encoder":33,"./segments":35,"./utils":36,"./version":38,"isarray":14}],33:[function(require,module,exports){
var BufferUtil = require('../utils/buffer')
...
},{"../utils/buffer":42,"./polynomial":31,"buffer":10}],34:[function(require,module,exports){
var numeric = '[0-9]+'
...
},{"./alphanumeric-data":18,"./byte-data":21,"./kanji-data":27,"./mode":29,"./numeric-data":30,"./regex":34,"./utils":36,"dijkstrajs":11}],36:[function(require,module,exports){
var toSJISFunction
var CODEWORDS_COUNT = [
  0, // Not used
...
},{"./error-correction-code":22,"./error-correction-level":23,"./mode":29,"./utils":36,"./version-check":37,"isarray":14}],39:[function(require,module,exports){
var Utils = require('./utils')
...
},{"buffer":10,"isarray":14}],"nebpay":[function(require,module,exports){
"use strict";
...
},{"./libs/config":3,"./libs/http":5,"./libs/pay":6,"bignumber.js":9,"extend":12}]},{},[]);
