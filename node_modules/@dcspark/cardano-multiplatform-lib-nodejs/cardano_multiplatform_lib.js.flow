/**
 * Flowtype definitions for cardano_multiplatform_lib
 ...
 * @returns {BigNum}
 */
declare export function compatible_min_ada_required(
 ...
 * @returns {BigNum}
 */
declare export function min_no_script_fee(
  tx: Transaction,
...
declare export var StakeDistributionKind: {|
  +BootstrapEraDistr: 0, // 0
  +SingleKeyDistr: 1, // 1
|};
...
declare export var AddrtypeKind: {|
  +ATPubKey: 0, // 0
  +ATScript: 1, // 1
  +ATRedeem: 2, // 2
|};
...
declare export var SpendingDataKind: {|
  +SpendingDataPubKeyASD: 0, // 0
  +SpendingDataScriptASD: 1, // 1
  +SpendingDataRedeemASD: 2, // 2
|};
...
declare export var ChangeSelectionAlgo: {|
  +Default: 0, // 0
|};
...
/**
 */
declare export class AddrAttributes {
  free(): void;
  ...
  /**
   * @returns {AddrAttributesJSON}
   */
  to_js_value(): AddrAttributesJSON;
  ...
  /**
   * @returns {StakeDistribution | void}
   */
  stake_distribution(): StakeDistribution | void;
  ...
  /**
   * @returns {HDAddressPayload | void}
   */
  derivation_path(): HDAddressPayload | void;
  ...
  /**
   * @returns {ProtocolMagic | void}
   */
  protocol_magic(): ProtocolMagic | void;
  ...
  /**
   * @param {HDAddressPayload | void} hdap
   * @param {ProtocolMagic | void} protocol_magic
   * @returns {AddrAttributes}
   */
  static new_bootstrap_era(
    hdap?: HDAddressPayload,
   ...
   * @returns {AddrAttributes}
   */
  static new_single_key(
    pubk: Bip32PublicKey,
    hdap: HDAddressPayload | void,
    protocol_magic: ProtocolMagic
  ): AddrAttributes;
}
/**
...
/**
 */
declare export class AddressContent {
  free(): void;
  ...
  /**
   * @returns {AddressContentJSON}
   */
  to_js_value(): AddressContentJSON;
...
/**
 */
declare export class AddressId {
  free(): void;
...
declare export class AuxiliaryData {
  ...
  /**
   * @returns {PlutusV1Scripts | void}
   */
  plutus_v1_scripts(): PlutusV1Scripts | void;
  ...
  /**
   * @returns {PlutusV2Scripts | void}
   */
  plutus_v2_scripts(): PlutusV2Scripts | void;
...
/**
 */
declare export class BlockBodyHash {
  free(): void;
...
/**
 */
declare export class BlockHeaderHash {
  free(): void;
...
/**
 */
declare export class BootstrapEraDistr {
  free(): void;
  ...
  /**
   * @returns {BootstrapEraDistrJSON}
   */
  to_js_value(): BootstrapEraDistrJSON;
...
/**
 */
declare export class ByronAddrType {
  free(): void;
  ...
  /**
   * @returns {ByronAddrTypeJSON}
   */
  to_js_value(): ByronAddrTypeJSON;
...
declare export class ByronAddress {
  ...
  /**
   * @returns {ByronAddressJSON}
   */
  to_js_value(): ByronAddressJSON;
...
/**
 */
declare export class ByronScript {
  free(): void;
...
/**
 */
declare export class ByronTxout {
  free(): void;
  ...
  /**
   * @returns {ByronTxoutJSON}
   */
  to_js_value(): ByronTxoutJSON;
...
declare export class Costmdls {
   ...
   */
  insert(value: CostModel): CostModel | void;
...
declare export class Datum {
   ...
   */
  as_data_hash(): DataHash | void;

  /**
   * @returns {PlutusData | void}
   */
  as_inline_data(): PlutusData | void;
}
/**
 */
...
/**
 */
declare export class HDAddressPayload {
  free(): void;
...
declare export class HeaderBody {
  ...
  /**
   * @returns {BlockHeaderHash | void}
   */
  prev_hash(): BlockHeaderHash | void;
   ...
   */
  vrf_result(): VRFCert | void;

  /**
   * * Present in all pre-Vasil blocks, but not later ones
   * @returns {VRFCert | void}
   */
  leader_vrf(): VRFCert | void;

  /**
   * * Present in all pre-Vasil blocks, but not later ones
   * @returns {VRFCert | void}
   */
  nonce_vrf(): VRFCert | void;
   ...
   * @param {BigNum} slot
   * @param {BlockHeaderHash | void} prev_hash
...
/**
 */
declare export class PlutusScriptWitness {
  free(): void;
...
/**
 */
declare export class PlutusV1Script {
  free(): void;
  ...
  /**
   * @returns {PlutusV1ScriptJSON}
   */
  to_js_value(): PlutusV1ScriptJSON;
...
/**
 */
declare export class PlutusV1Scripts {
  free(): void;
  ...
  /**
   * @returns {PlutusV1ScriptsJSON}
   */
  to_js_value(): PlutusV1ScriptsJSON;
...
/**
 */
declare export class PlutusV2Script {
  free(): void;
  ...
  /**
   * @returns {PlutusV2ScriptJSON}
   */
  to_js_value(): PlutusV2ScriptJSON;
...
/**
 */
declare export class PlutusV2Scripts {
  free(): void;
  ...
  /**
   * @returns {PlutusV2ScriptsJSON}
   */
  to_js_value(): PlutusV2ScriptsJSON;
...
/**
 */
declare export class ProtocolMagic {
  free(): void;
...
declare export class Script {
   ...
   */
  as_native(): NativeScript | void;

  /**
   * @returns {PlutusV1Script | void}
   */
  as_plutus_v1(): PlutusV1Script | void;

  /**
   * @returns {PlutusV2Script | void}
   */
  as_plutus_v2(): PlutusV2Script | void;
...
/**
 */
declare export class SignedTxBuilder {
  free(): void;
...
/**
 */
declare export class SingleKeyDistr {
  free(): void;
  ...
  /**
   * @returns {SingleKeyDistrJSON}
   */
  to_js_value(): SingleKeyDistrJSON;
...
/**
 */
declare export class SpendingData {
  free(): void;
  ...
  /**
   * @returns {SpendingDataJSON}
   */
  to_js_value(): SpendingDataJSON;
   ...
   * @returns {SpendingData}
   */
  static new_spending_data_pub_key(
  ...
  /**
   * @returns {SpendingDataPubKeyASD | void}
   */
  as_spending_data_pub_key(): SpendingDataPubKeyASD | void;

  /**
   * @returns {SpendingDataScriptASD | void}
   */
  as_spending_data_script(): SpendingDataScriptASD | void;

  /**
   * @returns {SpendingDataRedeemASD | void}
   */
  as_spending_data_redeem(): SpendingDataRedeemASD | void;
}
/**
 */
declare export class SpendingDataPubKeyASD {
  free(): void;
  ...
  /**
   * @returns {SpendingDataPubKeyASDJSON}
   */
  to_js_value(): SpendingDataPubKeyASDJSON;
...
/**
 */
declare export class SpendingDataRedeemASD {
  free(): void;
  ...
  /**
   * @returns {SpendingDataRedeemASDJSON}
   */
  to_js_value(): SpendingDataRedeemASDJSON;
...
/**
 */
declare export class SpendingDataScriptASD {
  free(): void;
  ...
  /**
   * @returns {SpendingDataScriptASDJSON}
   */
  to_js_value(): SpendingDataScriptASDJSON;
...
/**
 */
declare export class StakeDistribution {
  free(): void;
  ...
  /**
   * @returns {StakeDistributionJSON}
   */
  to_js_value(): StakeDistributionJSON;
  ...
  /**
   * @returns {BootstrapEraDistr | void}
   */
  as_bootstrap_era_distr(): BootstrapEraDistr | void;

  /**
   * @returns {SingleKeyDistr | void}
   */
  as_single_key_distr(): SingleKeyDistr | void;
...
/**
 */
declare export class StakeholderId {
  free(): void;
...
declare export class TransactionBuilder {
   ...
   * @returns {Withdrawals | void}
   */
  get_withdrawals(): Withdrawals | void;
...
declare export class TransactionOutputAmountBuilder {
   ...
   * @param {MultiAsset} multiasset
   * @param {BigNum} coins_per_utxo_byte
   * @param {BigNum | void} coins_per_utxo_word
   * @returns {TransactionOutputAmountBuilder}
   */
...
/**
 */
declare export class TxRedeemerBuilder {
  free(): void;
...
export interface AddrAttributesJSON {
  derivation_path?: HDAddressPayload | null;
  protocol_magic?: ProtocolMagic | null;
  stake_distribution?: StakeDistributionJSON | null;
}
export type AddressJSON = string;
export interface AddressContentJSON {
  addr_attr: AddrAttributesJSON;
  addr_type: AddrTypeEnumJSON;
  address_id: string;
}
...
export interface BootstrapEraDistrJSON {}
...
export type ByronAddrTypeJSON = AddrTypeEnumJSON;
export type AddrTypeEnumJSON = "ATPubKey" | "ATScript" | "ATRedeem";
...
export interface CostModelJSON {
 ...
 * structure to compute the CRC32 of chunks of bytes.
 *
 * This structure allows implements the `Write` trait making it easier to compute the crc32 of a stream.
 */
...
export interface HeaderBodyJSON {
  ...
  leader_vrf?: VRFCertJSON | null;
  nonce_vrf?: VRFCertJSON | null;
  operational_cert: OperationalCertJSON;
  prev_hash?: string | null;
  protocol_version: ProtocolVersionJSON;
  slot: string;
  vrf_result?: VRFCertJSON | null;
  vrf_vkey: string;
}
...
export type PlutusV1ScriptsJSON = string[];
export type PlutusV2ScriptJSON = string;
export type PlutusV2ScriptsJSON = string[];
...
export interface SingleKeyDistrJSON {
  stakeholder_id: string;
}
export type SpendingDataJSON = SpendingDataEnumJSON;
export type SpendingDataEnumJSON =
  | {
      SpendingDataPubKeyASDJSON: SpendingDataPubKeyASD,
      ...
    }
  | {
      SpendingDataScriptASDJSON: SpendingDataScriptASD,
      ...
    }
  | {
      SpendingDataRedeemASDJSON: SpendingDataRedeemASD,
      ...
    };
export interface SpendingDataPubKeyASDJSON {
  public_ed25519_bip32: string;
}
export interface SpendingDataRedeemASDJSON {
  public_ed25519: string;
}
export interface SpendingDataScriptASDJSON {
  script: ByronScript;
}
...
export type StakeDistributionJSON = StakeDistributionEnumJSON;
export type StakeDistributionEnumJSON =
  | {
      BootstrapEraDistrJSON: BootstrapEraDistr,
      ...
    }
  | {
      SingleKeyDistrJSON: SingleKeyDistr,
      ...
    };
...
export interface TransactionOutputJSON {
  address: string;
  amount: ValueJSON;
  datum_option?: DatumEnumJSON | null;
...
export type VkeyJSON = PublicKeyJSON;
/**
 * ED25519 key used as public key
 */
