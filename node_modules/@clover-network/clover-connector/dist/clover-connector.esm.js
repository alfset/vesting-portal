...
var NoCloverProviderError = /*#__PURE__*/function (_Error) {
  _inheritsLoose(NoCloverProviderError, _Error);

  function NoCloverProviderError() {
    var _this;

    _this = _Error.call(this) || this;
    _this.name = _this.constructor.name;
    _this.message = "No Clover provider was found on window.clover.";
    return _this;
  }

  return NoCloverProviderError;
...
var CloverConnector = /*#__PURE__*/function (_AbstractConnector) {
  _inheritsLoose(CloverConnector, _AbstractConnector);

  function CloverConnector(kwargs) {
    var _this3;
    ...
    _this3.getCloverProvider = _this3.getCloverProvider.bind(_assertThisInitialized(_this3));
    return _this3;
  }

  var _proto = CloverConnector.prototype;
  ...
  _proto.handleChainChanged = function handleChainChanged(chainId) {
    ...
    this.emitUpdate({
      chainId: chainId,
      provider: this.getCloverProvider()
    });
  };
  ...
  _proto.getCloverProvider = function getCloverProvider() {
    var _provider$providers;

    var provider = window.clover;

    if (provider != null && (_provider$providers = provider.providers) != null && _provider$providers.length) {
      var _provider$providers$f;

      return (_provider$providers$f = provider.providers.find(function (p) {
        return p.isClover;
      })) != null ? _provider$providers$f : provider.providers[0];
    }
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _context.prev = 5;
              _context.next = 8;
              return provider.send("eth_requestAccounts").then(function (sendReturn) {
            ...
            case 16:
              ...
              _context.next = 19;
              return provider.enable().then(function (sendReturn) {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", this.getCloverProvider());
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _context3.prev = 3;
              _context3.next = 6;
              return provider.send("eth_chainId").then(parseSendReturn);
            ...
            case 12:
              ...
              _context3.prev = 13;
              _context3.next = 16;
              return provider.send("net_version").then(parseSendReturn);
            ...
            case 22:
              if (!chainId) {
                try {
                  chainId = parseSendReturn(provider.send({
                    method: "net_version"
                  }));
                } catch (_unused3) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              _context4.prev = 3;
              _context4.next = 6;
              return provider.send("eth_accounts").then(function (sendReturn) {
                return parseSendReturn(sendReturn)[0];
              });
            ...
            case 22:
              if (!account) {
                account = parseSendReturn(provider.send({
                  method: "eth_accounts"
                }))[0];
              }
  ...
  _proto.deactivate = function deactivate() {
    var provider = this.getCloverProvider();

    if (provider != null && provider.removeListener) {
  ...
  _proto.isAuthorized = /*#__PURE__*/function () {
    var _isAuthorized = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5() {
      var provider;
...
export { CloverConnector, NoCloverProviderError, UserRejectedRequestError };
//# sourceMappingURL=clover-connector.esm.js.map
