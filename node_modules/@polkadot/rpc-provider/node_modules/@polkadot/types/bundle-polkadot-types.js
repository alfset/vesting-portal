const polkadotTypes = (function (exports, util, utilCrypto) {
  ...
  const definitions$c = {
    rpc: {},
    types: _objectSpread$q(_objectSpread$q(_objectSpread$q(_objectSpread$q(_objectSpread$q(_objectSpread$q(_objectSpread$q({}, location), xcm), v0$1), v1$1), v2), mapXcm(XCM_LATEST)), {}, {
      DoubleEncodedCall: {
        encoded: 'Vec<u8>'
      },
      XcmOriginKind: {
  ...
  const definitions$b = {
    ...
    types: _objectSpread$p(_objectSpread$p(_objectSpread$p({}, layout), spec), {}, {
      ...
      ContractProjectV0: _objectSpread$p(_objectSpread$p({
  ...
  const definitions$a = {
    rpc: {},
    types: _objectSpread$o(_objectSpread$o(_objectSpread$o({}, v0), v1), {}, {
      // latest mappings
      SiField: 'Si1Field',
  ...
  const rpc = _objectSpread$n(_objectSpread$n(_objectSpread$n({}, netRpc), web3Rpc), {}, {
    accounts: {
  ...
  const types = _objectSpread$m(_objectSpread$m(_objectSpread$m(_objectSpread$m({}, V0), V1), V2), {}, {
  ...
  const v14 = {
    ...
    ErrorMetadataV14: _objectSpread$l(_objectSpread$l({}, Si1Variant), {}, {
      args: 'Vec<Type>'
    }),
    EventMetadataV14: _objectSpread$l(_objectSpread$l({}, Si1Variant), {}, {
      args: 'Vec<Type>'
    }),
    FunctionArgumentMetadataV14: 'FunctionArgumentMetadataV13',
    FunctionMetadataV14: _objectSpread$l(_objectSpread$l({}, Si1Variant), {}, {
  ...
  */
    ...
    return registry.createType('MetadataLatest', {
      ...
      lookup: {
        types: lookup.types.map(({
          ...
          id,
          type: _objectSpread$h(_objectSpread$h({}, type), {}, {
  ...
  function encodeSubTypes(registry, sub, asEnum, extra) {
    ...
    const inner = sub.reduce((result, type) => _objectSpread$g(_objectSpread$g({}, result), {}, {
      [type.name]: encodeTypeDef(registry, type)
    }), _objectSpread$g({}, extra));
  ...
  const encoders = {
    ...
    [exports.TypeDefInfo.Set]: (registry, {
      ...
      return util.stringify({
        _set: sub.reduce((all, {
          index,
          name
        }, count) => _objectSpread$g(_objectSpread$g({}, all), {}, {
    ...
    [exports.TypeDefInfo.Struct]: (registry, {
      ...
      return encodeSubTypes(registry, sub, false, _objectSpread$g({}, alias ? {
        _alias: [...alias.entries()].reduce((all, [k, v]) => _objectSpread$g(_objectSpread$g({}, all), {}, {
          [k]: v
        }), {})
      } : {}));
    },
  ...
  function withTypeString(registry, typeDef) {
    return _objectSpread$g(_objectSpread$g({}, typeDef), {}, {
  ...
  const allExtensions = _objectSpread$f(_objectSpread$f(_objectSpread$f(_objectSpread$f({}, substrate$1), polkadot), shell), statemint); // the v4 signed extensions prior to the point of exposing these to the metadata.
  ...
  function expandExtensionTypes(extensions, type, userExtensions = {}) {
    ...
    .map(key => userExtensions[key] || allExtensions[key]).filter(info => !!info).reduce((result, info) => _objectSpread$f(_objectSpread$f({}, result), info[type]), {});
  }
  ...
  class GenericSignerPayload extends Struct {
    constructor(registry, value) {
      const extensionTypes = _objectSpread$c(_objectSpread$c({}, registry.getSignedExtensionTypes()), registry.getSignedExtensionExtra());

      super(registry, _objectSpread$c(_objectSpread$c({}, extensionTypes), knownTypes), value); // add all extras that are not in the base types
    ...
    toPayload() {
      return _objectSpread$c(_objectSpread$c({}, Object.keys(this._extraTypes).reduce((map, key) => {
        const value = this.get(key);
  ...
  class GenericExtrinsicPayloadV4 extends Struct {
    constructor(registry, value) {
      super(registry, _objectSpread$b(_objectSpread$b({
        method: 'Bytes'
  ...
  class GenericExtrinsicSignatureV4 extends Struct {
    constructor(registry, value, {
      ...
      super(registry, _objectSpread$a({
        signer: 'Address',
        // eslint-disable-next-line sort-keys
  ...
  function _extractFields2(lookupIndex, fields) {
    ...
    if (fields.length === 0) {
      ...
      return _objectSpread$8(_objectSpread$8({}, typeDef), lookupIndex === -1 ? {} : {
        lookupIndex,
        lookupName: _classPrivateFieldBase(this, _names)[_names][lookupIndex],
    ...
    return withTypeString(this.registry, _objectSpread$8(_objectSpread$8(_objectSpread$8({
  ...
  function _extractFieldsAlias2(fields) {
    ...
    const sub = fields.map(({
      ...
      return _objectSpread$8(_objectSpread$8({}, typeDef), {}, {
  ...
  function _extractHistoric2(_, type) {
    return _objectSpread$8(_objectSpread$8({}, getTypeDef(type)), {}, {
  ...
  function _extractVariantEnum2(lookupIndex, variants) {
    ...
    [...variants].sort((a, b) => a.index.cmp(b.index)).forEach(({
      ...
      sub.push(_objectSpread$8(_objectSpread$8({}, _classPrivateFieldBase(this, _extractFields)[_extractFields](-1, fields)), {}, {
        index: index.toNumber(),
        name: name.toString()
      }));
    });
  ...
  function createStorageType(registry, entryType) {
    if (entryType.isMap) {
      return [_objectSpread$7(_objectSpread$7({}, entryType.asMap), {}, {
        hasher: createStorageHasher(registry, entryType.asMap.hasher)
      }), 1];
    }

    if (entryType.isDoubleMap) {
      return [_objectSpread$7(_objectSpread$7({}, entryType.asDoubleMap), {}, {
  ...
  function convertModule(registry, mod) {
    ...
    return registry.createType('ModuleMetadataV10', _objectSpread$7(_objectSpread$7({}, mod), {}, {
      storage: storage ? _objectSpread$7(_objectSpread$7({}, storage), {}, {
        items: storage.items.map(item => _objectSpread$7(_objectSpread$7({}, item), {}, {
  ...
  function toV12(registry, {
    ...
    return registry.createType('MetadataV12', {
      extrinsic,
      modules: modules.map(mod => registry.createType('ModuleMetadataV12', _objectSpread$6(_objectSpread$6({}, mod), {}, {
        index: 255
      })))
    });
  }
  ...
  function getModuleTypes({
    ...
    return _objectSpread$5(_objectSpread$5({}, typesModules$1[section] || {}), ((_knownTypes$typesAlia = knownTypes.typesAlias) === null || _knownTypes$typesAlia === void 0 ? void 0 : _knownTypes$typesAlia[section]) || {});
  }
  ...
  class TypeRegistry {
    ...
    getClassName(Type) {
      ...
      const names = [..._classPrivateFieldBase(this, _classes)[_classes].entries()].filter(([, Clazz]) => Type === Clazz).map(([name]) => name).sort().reverse();
