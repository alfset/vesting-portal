...
import { decodeBase64, encodeUTF8, encodeBase64, decodeUTF8 } from 'tweetnacl-util';
...
var uncurryThis$k = NATIVE_BIND$3 && bind$7.bind(call$j, call$j);
...
var toString$3 = uncurryThis$j({}.toString);
...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$h(fn = input.toString) && !isObject$a(val = call$h(fn, input))) return val;
  if (isCallable$h(fn = input.valueOf) && !isObject$a(val = call$h(fn, input))) return val;
  if (pref !== 'string' && isCallable$h(fn = input.toString) && !isObject$a(val = call$h(fn, input))) return val;
...
Function.prototype.toString = makeBuiltIn$1(function toString() {
  return isCallable$e(this) && getInternalState$4(this).source || inspectSource$2(this);
}, 'toString');
...
var handlePrototype = function (CollectionPrototype, COLLECTION_NAME) {
  if (CollectionPrototype) {
    ...
    if (!CollectionPrototype[TO_STRING_TAG$3]) {
      createNonEnumerableProperty$3(CollectionPrototype, TO_STRING_TAG$3, COLLECTION_NAME);
    }
...
var engineIsNode = classof$9(global$f.process) == 'process';
...
const WalletList = ({
      ...
      result.push(jsxs("li", Object.assign({
        ...
        children: [jsx("div", Object.assign({
          ...
          children: [jsx("div", Object.assign({
            ...
            children: translate(`modal.exportAccounts.walletTypes.${module.type}`)
          }))]
  ...
  return jsx("div", {
    children: selector.options.optimizeWalletOrder && selector.store.getState().recentlySignedInWallets.length > 0 ? jsx("div", Object.assign({
      ...
      children: [jsxs("div", Object.assign({
        ...
        children: [jsxs("svg", Object.assign({
          ...
          children: [jsx("rect", {
            ...
            children: jsxs("radialGradient", Object.assign({
          ...
          children: [jsx("h3", {
            children: translate("modal.exportAccounts.chooseAWallet")
          }), jsx("p", {
            children: translate("modal.exportAccounts.selectAWallet")
          })]
        }))]
      })), jsxs("div", Object.assign({
        className: "wallet-what"
        ...
        children: [jsxs("svg", Object.assign({
          ...
          children: [jsx("h3", {
            children: translate("modal.exportAccounts.selectYourAccounts")
          }), jsx("p", {
            children: translate("modal.exportAccounts.afterDecide")
          })]
        }))]
      })), jsx("div", {
        ...
        children: jsx("p", {
          children: translate("modal.exportAccounts.disclaimer")
        })
      }))]
    }))]
  }));
...
var isRegexp = function (it) {
  var isRegExp;
  return isObject$7(it) && ((isRegExp = it[MATCH$1]) !== undefined ? !!isRegExp : classof$8(it) == 'RegExp');
};
...
var speciesConstructor$2 = function (O, defaultConstructor) {
  ...
  var S;
  return C === undefined || (S = anObject$7(C)[SPECIES$2]) == undefined ? defaultConstructor : aConstructor$1(S);
};
...
var bind$6 = uncurryThis$6(uncurryThis$6.bind);
...
var arraySlice$4 = uncurryThis$5([].slice);
...
var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$4(global$9.PromiseRejectionEvent);
...
const getWarningLabel = ({
  ...
  if (type === ACCESS_KEY_TYPES.UNKNOWN) {
    return jsx("span", Object.assign({
      ...
      children: translate("modal.exportAccounts.selectAccounts.error")
    }));
  }
  ...
  if (type === ACCESS_KEY_TYPES.LEDGER) {
    return jsx("span", Object.assign({
      ...
      children: translate("modal.exportAccounts.selectAccounts.warningLedger")
    }));
  }
  ...
  if (!hasBalance) {
    return jsx("span", Object.assign({
      ...
      children: translate("modal.exportAccounts.selectAccounts.noBalance")
    }));
  }
...
const AccountSelect = ({
  ...
  const onAccountSelect = (accountId, checked) => {
    if (checked) {
      setSelectedAccounts([...selectedAccounts, accountId]);
    } else {
      setSelectedAccounts(selectedAccounts.filter(existingAccountId => existingAccountId !== accountId));
    }
  };
  ...
  const onSelectAll = () => {
    ...
    setSelectedAccounts(accountsWithDetail.map(({
      accountId
    }) => accountId));
  };
  ...
  return jsxs(Fragment, {
    children: [jsx("div", Object.assign({
      ...
      className: "account-export connecting-wrapper"
    }, {
      children: jsx("div", Object.assign({
        className: "content"
      }, {
        children: isLoading ? jsx("div", Object.assign({
          className: "connecting-details"
        }, {
          children: jsx("div", Object.assign({
            className: "spinner account-selection-spinner"
          }, {
            children: jsx("img", {
              src: LOADING_ICON_DATA_URL,
              alt: "loading-icon"
            })
          }))
        })) : jsxs(Fragment$1, {
          children: [jsx("span", Object.assign({
            className: "account-select-all",
            onClick: onSelectAll
          }, {
            ...
            children: accountsWithDetail.map(({
              accountId
            }) => jsx("div", Object.assign({
          ...
          })), disabledAccounts.length > 0 && jsxs(Fragment$1, {
            children: [jsx("span", Object.assign({
              className: "account-unavailable"
            }, {
              children: translate("modal.exportAccounts.selectAccounts.unavailable")
            })), jsx("div", Object.assign({
              className: "account-selection"
            }, {
              children: disabledAccounts.map(({
                accountId,
                type,
                hasBalance
              }) => jsx("div", Object.assign({
...
if (!NATIVE_ARRAY_BUFFER$1) {
  ...
  var $setInt8 = uncurryThis$4(DataViewPrototype$1.setInt8);
...
var un$ArrayBufferSlice = uncurryThis$3(ArrayBuffer$3.prototype.slice);
var getUint8 = uncurryThis$3(DataViewPrototype.getUint8);
var setUint8 = uncurryThis$3(DataViewPrototype.setUint8);
...
var NATIVE_ARRAY_BUFFER_VIEWS$2 = NATIVE_ARRAY_BUFFER && !!setPrototypeOf$2 && classof$3(global$6.opera) !== 'Opera';
...
const encryptAccountData = ({
  ...
  try {
    const keyUint8Array = decodeBase64(Buffer.from(secretKey).toString("base64"));
...
const decryptAccountData = ({
  ...
  try {
    ...
    const message = messageWithNonceAsUint8Array.slice(nacl.secretbox.nonceLength, ciphertext.length);
...
const ClickToCopy = ({
  ...
  return jsxs("button", Object.assign({
    ...
    children: [children, jsx("div", Object.assign({
      className: `copy-success${show ? " show" : ""}`
    }, {
      children: translate("component.clickToCopy.label")
    }))]
  }));
};
    ...
    children: [jsx(ModalHeader, {
      ...
      children: jsxs("div", Object.assign({
        ...
        children: [jsx("h4", Object.assign({
          className: "passphrase-title"
        }, {
          children: translate("modal.exportAccounts.getPassphrase.desc")
        })), jsx(ClickToCopy, Object.assign({
          copy: secretKey,
          id: "passphraseButton"
        }, {
          children: jsx("div", Object.assign({
          ...
          htmlFor: "passphraseButton",
          className: "passphrase-label"
        }, {
          children: translate("modal.exportAccounts.getPassphrase.label")
        })), jsx("div", {
          className: "filler"
        }), jsxs("div", Object.assign({
          className: "checkbox"
          ...
          children: [jsx("input", {
            ...
            htmlFor: "passphrase-check"
          }, {
            children: translate("modal.exportAccounts.getPassphrase.checkLabel")
          }))]
        })), jsx("button", Object.assign({
          className: "middleButton account-export-button",
          ...
          children: translate("modal.exportAccounts.getPassphrase.button")
        }))]
      }))
    }))]
  });
...
const Complete = ({
  ...
  return jsxs(Fragment$1, {
    children: [jsx("div", Object.assign({
      ...
      children: [jsx("h4", {
        children: translate("modal.exportAccounts.complete.descOne")
      }), jsx("h4", {
        children: translate("modal.exportAccounts.complete.descTwo")
      })]
    })), jsx("button", Object.assign({
      className: "middleButton account-export-button",
      onClick: onClick
    }, {
      children: translate("modal.exportAccounts.complete.button")
    }))]
  });
};
...
const permissionToType = permission => {
  var _a, _b;
  ...
  if ((_a = permission === null || permission === void 0 ? void 0 : permission.FunctionCall) === null || _a === void 0 ? void 0 : _a.method_names.includes("__wallet__metadata")) {
    return ACCESS_KEY_TYPES.LEDGER;
  }

  const multiSigMethods = ["add_request", "add_request_and_confirm", "delete_request", "confirm"];

  if ( //@ts-ignore
  (_b = permission === null || permission === void 0 ? void 0 : permission.FunctionCall) === null || _b === void 0 ? void 0 : _b.method_names.every(method => multiSigMethods.includes(method))) {
...
const ExportAccount = ({
  ...
  const [passphrase, setPassphrase] = useState(""); //@ts-ignore

  const [exportInterfaces, setExportInterfaces] = useState({});
  useEffect(() => {
    const getExportInterfaces = () => __awaiter(void 0, void 0, void 0, function* () {
      try {
        const {
          // @ts-ignore
    ...
    getExportInterfaces(); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [module === null || module === void 0 ? void 0 : module.metadata.name, alertMessage]);
  const {
    network
  } = selector.options;
  ...
  useEffect(() => {
    const initialize = () => __awaiter(void 0, void 0, void 0, function* () {
      setIsLoading(true);
      const accountsWithDetails = yield Promise.all(accounts.map(({
        accountId,
        privateKey
      }) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  }, [exportInterfaces.buildImportAccountsUrl, exportInterfaces.importAccountsInSecureContext]);
  ...
  const showAccountSelection = () => setStep(EXPORT_ACCOUNT_STEPS.ACCOUNT_SELECTION);
  ...
  const onAccountSelectNext = () => {
    if (wallet.type === "injected" && !wallet.metadata.useUrlAccountImport) {
  ...
  const injectedWalletInterface = () => __awaiter(void 0, void 0, void 0, function* () {
    if (importAccountsInSecureContext) {
      yield importAccountsInSecureContext({
  ...
  const browserOrMobileInterface = () => {
    ...
    const isUrlCompatible = wallet.type === "browser" || wallet.metadata.useUrlAccountImport;
  ...
  return jsxs(Fragment, {
    children: [step === EXPORT_ACCOUNT_STEPS.NO_INTERFACE && jsx(NoInterface, {
      src: module === null || module === void 0 ? void 0 : module.metadata.iconUrl,
      name: module === null || module === void 0 ? void 0 : module.metadata.name,
      alertMessage: alertMessage,
      onBack: onBack,
      onCloseModal: onCloseModal
    }), step === EXPORT_ACCOUNT_STEPS.ACCOUNT_SELECTION && jsx(AccountSelect, {
      onCloseModal: onCloseModal,
      onBack: onBack,
      ...
      isLoading: isLoading,
      buttonLabel: wallet.type === "injected" ? "modal.exportAccounts.getPassphrase.button" : "modal.exportAccounts.selectAccounts.button"
    }), step === EXPORT_ACCOUNT_STEPS.GET_PASSPHRASE && jsx(Passphrase, {
    ...
    }), step === EXPORT_ACCOUNT_STEPS.COMPLETE && jsx(Complete, {
      onCloseModal: onCloseModal,
...
const ExportSelector = ({
  ...
  const handleWarning = useCallback(() => {
    if (selectedWallet) {
      setAlertMessage(`${selectedWallet === null || selectedWallet === void 0 ? void 0 : selectedWallet.metadata.name} ${translate("modal.exportAccounts.warning")}`);
      setRoute({
        name: "AlertMessage",
        params: {
  ...
  return jsxs("div", Object.assign({
    ...
    children: [jsx("div", {
      ...
      children: [jsxs("div", Object.assign({
        ...
        children: jsxs("div", Object.assign({
          className: "nws-modal-body account-export-body"
        }, {
          children: [route.name === "AlertMessage" && alertMessage && jsx(AlertMessage, {
            ...
            onCloseModal: handleDismissClick
          }), route.name === "WalletHome" && jsx(Home, {
            onCloseModal: handleDismissClick
          }), route.name === "ExportAccounts" && jsx(ExportAccount, {
            module: (_c = route.params) === null || _c === void 0 ? void 0 : _c.module,
            alertMessage: alertMessage,
            onCloseModal: handleDismissClick,
            ...
            onComplete: options === null || options === void 0 ? void 0 : options.onComplete
          })]
        }))
      }))]
    }))]
...
const setupExportSelectorModal = (selector, options) => {
  ...
  const render = visible => {
    root.render(jsx(ExportSelector, {
      selector: selector,
      options: options,
      visible: visible,
      hide: () => render(false)
...
export { decryptAccountData, setupExportSelectorModal };
