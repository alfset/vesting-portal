...
const Coin98Wallet = ({
  ...
  const getAccounts = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const publicKey = yield _state.wallet.near.signer.getPublicKey(accountId, options.network.networkId);
    return [{
      accountId,
  ...
  return {
    signIn({
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _state.wallet.near.connect({
    ...
    signOut() {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _state.wallet.near.disconnect();
      });
    },
    ...
    verifyOwner({
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const pubKey = yield _state.wallet.near.signer.getPublicKey(accountId);
    ...
    signAndSendTransaction({
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const signedTransactions = yield walletUtils.signTransactions(transformTransactions([{
          ...
          receiverId,
          actions
        }]), _state.wallet.near.signer, options.network);
    ...
    signAndSendTransactions({
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const signedTransactions = yield walletUtils.signTransactions(transformTransactions(transactions), _state.wallet.near.signer, options.network);
  ...
  return () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
      ...
      metadata: {
        ...
        iconUrl: _iconUrl,
        downloadUrl: "https://chrome.google.com/webstore/detail/coin98-wallet/aeachknmefphepccionboohckonoeemg",
...
exports.setupCoin98Wallet = setupCoin98Wallet;
