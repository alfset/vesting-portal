...
var store$3 = global$4[SHARED] || defineGlobalProperty$1(SHARED, {});
...
const setupXDEFIState = (store, network) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const wallet = window.xfi.near; // Attempt to reconnect wallet if previously selected.
